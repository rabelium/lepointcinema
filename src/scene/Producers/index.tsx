...
import style from './style/producers.style';
      ...
      {!loading && (
        <>
          <View style={style.header}>
            <Text style={style.headerText}>Producteurs</Text>
...
const mapStateToProps = (state: any) => ({...state?.producers});
...
export default connect(mapStateToProps, mapDispatchToProps)(ProducersScene);
