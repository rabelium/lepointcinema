...
import style from './style/actors.style';
      ...
      {!loading && (
        <>
          <View style={style.header}>
            <Text style={style.headerText}>Acteurs</Text>
...
const mapStateToProps = (state: any) => ({...state?.actors});
...
export default connect(mapStateToProps, mapDispatchToProps)(ActorsScene);
